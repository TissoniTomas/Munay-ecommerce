      ...
      <div className="flex  justify-center items-center w-full">
        <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
          <div>
            ...
            <p className="font-semibold text-xl leading-5 text-gray-800 dark:text-white lg:mt-10 mt-9">Durababilidad</p>
            <p className="text-normal text-base leading-6 text-gray-600 dark:text-white mt-4">La durabilidad del producto es un aspecto clave... Además, mejora la durabilidad de los productos.</p>
          </div>
          <div>
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-normal text-base leading-6 text-gray-600 dark:text-white mt-4"> Reutilizamos, reciclamos y reducimos la eliminación de residuos. Conservan energía y recursos naturales.</p>
          </div>
