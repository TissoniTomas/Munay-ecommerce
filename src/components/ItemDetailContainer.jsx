    ...
    <div className="2xl:CardContainer 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600 dark:text-white">Home / {products.category} / {products.title}</p>
          <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800  dark:text-white mt-4">{products.title}</h2>

          <p className=" font-normal text-base leading-6 text-gray-600 dark:text-white mt-7">{products.description}</p>
          <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 dark:text-white">$ {products.price}</p>
          ...
          <button
            className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white dark:text-black bg-black dark:bg-[#f3f3f9ef] w-full py-5 lg:mt-12 mt-6"
            onClick={addCartItem}
